...
Read the data.
```{r}
strompreise <- read.csv("Strompreise.csv")
```
...
# Rename columns.
colnames(dataframe) <- c("Jahresstunde", "Monat", "Tag", "Stunde", "Woche", "Wochentag", "Temperatur", "Bedeckung", "Windgeschwindigkeit", "Globalstrahlung", "Strompreis")
```
